...
func TestMintBiscuitToken(t *testing.T) {
	...
	authorizer1, err := b1.Authorizer(kr.GetCurrentPublicKey(), biscuit.WithWorldOptions(datalog.WithMaxDuration(5*time.Second)))
	if err != nil {
		t.Fatal(err)
	}
	...
	authorizer2, err := b2.Authorizer(kr.GetCurrentPublicKey(), biscuit.WithWorldOptions(datalog.WithMaxDuration(5*time.Second)))
	if err != nil {
		t.Fatal(err)
	}
	...
	authorizer3, err := b3.Authorizer(kr.GetCurrentPublicKey(), biscuit.WithWorldOptions(datalog.WithMaxDuration(5*time.Second)))
	if err != nil {
		t.Fatal(err)
	}
	...
	authorizer4, err := b4.Authorizer(kr.GetCurrentPublicKey(), biscuit.WithWorldOptions(datalog.WithMaxDuration(5*time.Second)))
	if err != nil {
		t.Fatal(err)
	}
...
func TestMintBiscuitToken_ClaimsTranslation(t *testing.T) {
	...
	authorizer, err := b.Authorizer(kr.GetCurrentPublicKey(), biscuit.WithWorldOptions(datalog.WithMaxDuration(5*time.Second)))
	if err != nil {
